...
✅ [UPPAbaby Vista double stroller](/posts/2024-07-10-uppa-baby-venn-diagram/) in the frunk  
✅ [SNOO](/posts/2024-07-06-happiest-ev/) in the trunk  
...
It turns out if we charge up to 100% (which we have!) and put the car in conserve mode it predicts we can go straight there with no stops -- nice! 
...
::: {.callout-note}
## Post Mortem: How it went

The drive went great! The kids did better than expected (5 week old was a champ!). We got a later start than planned due to a last minute doc visit but were still in Richmond before dinner. The stop was lovely and as predicted the Starbucks offered some much needed caffeine and a clean bathroom! We were the only vehicle at the charging station (phew! I had some last minute range anxiety when I realized I hadn't checked beforehand how often the spots were all filled! This can be seen in the Rivian app so I've added that to my pre-planning checklist!) and it charged very fast! Only hiccup -- both girls declared they desperately needed a bathroom when we were about twenty minutes from the stop 🤦‍♀️, so we ended up having to pull off at gas station, bleh! While there definitely are plenty of charging places along the route, unfortunately (or maybe fortunately since it saved us from christening our lovely back back) gas stations are way more ubiquitous. Noted!
:::
